...
<style>
	...
	/* The section's own name on the left, the headline readings spread across
	   the rest: a grid of its own rather than .band's divided cells, since this
	   is one box already and does not want a second border between its parts. */
	/* The section's own name on the left, the headline readings spread across
